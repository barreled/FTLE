...
#Only considers nodes in the first mesh
...
while 1:
  ...
  try:
	...
	continue
      ...
      if current not in mesh: continue #ignore anything not in the first mesh and force things from the first mesh to appear even if they're zeroes 
	...
	fh3.write(wi) #since z is always 0, use a shortcut
      ...
      for position, index, xi, yi, zi in pos:
	#if index == -1: continue #take out zero velocity data
